defmodule NSQ.ProducerTest do
  ...
  setup do
    ...
    Tesla.post("http://127.0.0.1:6751/topic/delete?topic=#{@test_topic}")
    Tesla.post("http://127.0.0.1:6761/topic/delete?topic=#{@test_topic}")
    Tesla.post("http://127.0.0.1:6771/topic/delete?topic=#{@test_topic}")
    Tesla.post("http://127.0.0.1:6781/topic/delete?topic=#{@test_topic}")
    :ok
  end
